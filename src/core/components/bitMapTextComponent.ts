...
import { BitmapText } from "../graphics/bitmaps/bitMapText";
...
/**
 * BitmapTextComponentData - Text data for Bitmap configuration
 *
 * Properties:
 * - name: Bitmap identifier
 * - fontName: Associated font name
 */
...
/**
 * BitmapTexteAssetLoader - Handles loading of text assets
 *
 * Features:
 * - Async text loading
 * - Text format support
 ...
 * Usage:
 * ```typescript
 * const loader = new BitmapTexteAssetLoader();
 * loader.loadAsset("assets/fonts/text.txt");
 * ```
 */
...
/**
 * BitmapTextComponent - Handles bitmap text configuration
 *
 * Features:
 * - Manages bitmap text
 * - Registers with global bitmpa manager
 *
 * Usage:
 * ```typescript
 * const text = new BitmapTextComponent(data);
 * ```
 */
